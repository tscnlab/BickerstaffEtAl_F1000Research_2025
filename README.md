...
1. Experimental data for both the "30-min" and "one-shot" laboratory parts: `data/lab_data/30_min_exp` and `data/lab_data/one_shot_exp`
...
2. Light exposure and sneeze log data: `data/real_world`
    The folder contains:
